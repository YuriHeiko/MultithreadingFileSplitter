...
public class SyncReadIO extends IOHandler {
    ...
    public void write(final String fileName,
        ...
        super.write(fileName, buffer, position, length);
    }
     ...
     */
    @Override
    public synchronized int read(final String fileName, byte[] buffer, final long position) throws IOHandlerException {
        log.debug("Trying to synchronously read");
        return super.read(fileName, buffer, position);
    }
}